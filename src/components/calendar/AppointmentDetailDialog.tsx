...
import { ClientProfile } from '@/types'; // SURGICAL ADDITION
...
interface AppointmentDetailDialogProps {
  ...
  client?: ClientProfile; // SURGICAL ADDITION
}

export function AppointmentDetailDialog({ isOpen, onClose, event, appointmentId, client }: AppointmentDetailDialogProps) {
  ...
  }, [isOpen, appointmentId, event, toast, onClose]);
