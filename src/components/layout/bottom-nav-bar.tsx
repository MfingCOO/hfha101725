...
export function BottomNavBar() {
    ...
    // ** THE FIX: The navItems array is re-ordered to place Chats in the middle. **
    const navItems = [
        ...
        // ** The Chat button is now correctly placed in the center position. **
        { href: '#', label: 'Chats', icon: MessageSquare, action: () => openChatModal(null), notification: hasUnreadChats },
            ...
            <nav className="flex items-center justify-around h-full">
                {navItems.map((item) => {
                    ...
                    return (
                        ...
                        >
                            {/* The notification dot is now handled within the map loop */}
                            {item.notification && (
